...
alt_threshold = 1000                   # threshold for altitude, should be around 1000 m
open_count2 = 100                     # when relay for altitude should be closed, should probably be around 500 
